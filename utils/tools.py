...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    elif args.lradj == 'type11':
        lr_adjust = {2: args.learning_rate * 0.5 ** 1, 4: args.learning_rate * 0.5 ** 2,
                     6: args.learning_rate * 0.5 ** 3, 8: args.learning_rate * 0.5 ** 4,
                     10: args.learning_rate * 0.5 ** 5, 12: args.learning_rate * 0.1 ** 5,
                     14: args.learning_rate * 0.5 ** 6, 16: args.learning_rate * 0.1 ** 6,
                     18: args.learning_rate * 0.5 ** 7, 20: args.learning_rate * 0.1 ** 7}
    elif args.lradj == 'type_PatchMLP':
