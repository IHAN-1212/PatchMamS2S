...
class MTSModel(nn.Module):
    def __init__(self, args):
        ...
        # Parameters
        seq_len = args.in_len   # lookback window L
        pred_len = args.out_len # prediction length (96, 192, 336, 720)
        c_in = args.data_dim       # input channels
        ...
        alpha = args.alpha       # smoothing factor for EMA (Exponential Moving Average)
        beta = args.beta         # smoothing factor for DEMA (Double Exponential Moving Average)
