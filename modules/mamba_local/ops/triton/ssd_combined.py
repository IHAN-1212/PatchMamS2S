...
from modules.mamba_local.ops.triton.dyt_norm import tanh_transform
...
def _mamba_chunk_scan_combined_fwd(x, dt, A, B, C, chunk_size, D=None, z=None, dt_bias=None, initial_states=None, seq_idx=None, dt_softplus=False, dt_limit=(0.0, float("inf"))):
    ...
    # initial_states (batch, nhead, headdim * dstate)
...
class MambaSplitConv1dScanCombinedFn(torch.autograd.Function):
    ...
    def forward(ctx, zxbcdt, conv1d_weight, conv1d_bias, dt_bias, A, D, chunk_size, initial_states=None, seq_idx=None, dt_limit=(0.0, float("inf")), return_final_states=False, activation="silu",
                ...
                ngroups=1, norm_before_gate=True, iscustom=False):
        ...
        if rmsnorm_weight is None:
            ...
            out, _, rstd = _layer_norm_fwd(x_rms, rmsnorm_weight, None, rmsnorm_eps, z_rms, out=out,
                                           ...
                                           norm_before_gate=norm_before_gate, is_rms_norm=True)# Mamba-2的新增Norm
            if d_nonssm == 0:
        ...
        if outproj_weight is not None:
            ...
            out = F.linear(out, outproj_weight, outproj_bias) # Mamba的最后一个Linear
        else:
    ...
    def backward(ctx, dout, *args):
        ...
        dxBC_given_update, dweight, dbias, *_ = causal_conv1d_bwd_function(
            ...
            rearrange(dxBC, "b s d -> b d s"), seq_idx, None, None, rearrange_and_update_stride(dxBC_given), False,
            ctx.activation in ["silu", "swish"]
        )
...
def mamba_split_conv1d_scan_combined(zxbcdt, conv1d_weight, conv1d_bias, dt_bias, A, D, chunk_size, initial_states=None,
    ...
    Return:
        out: (batch, seqlen, dim)
    """
    return MambaSplitConv1dScanCombinedFn.apply(zxbcdt, conv1d_weight, conv1d_bias, dt_bias, A, D, chunk_size, initial_states, seq_idx, dt_limit, return_final_states, activation, rmsnorm_weight, rmsnorm_eps, outproj_weight, outproj_bias, headdim, ngroups, norm_before_gate, iscustom)
