...
**PatchMamS2S: A Multivariate Time Series Forecasting Model for Power Load Based on Mamba with Integrated Patching Strategy**
...
```bash
python main.py --model PatchMamS2S --data ETTh1 --in_len 96 --out_len 96 --train_epochs 20 --batch_size 32 --learning_rate 0.0001 --d_model 256 --d_state 1 --headdim 8 --k 13 --ma_type ema
```

### Train with Different Moving Average Type
```bash
python main.py --model PatchMamS2S --data ETTh1 --in_len 96 --out_len 96 --ma_type dema --alpha 0.5 --beta 0.4
```
...
@article{lin2026patchmams2s,
  ...
  author={Lin, Yuhan and Ouyang, Haoyuan and Chen, Hongyu and Hong, Zhiyong and Xiong, Liping and Wang, Zhishuang},
  year={2026}
}
```
